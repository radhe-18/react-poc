...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white mt-16 animate-fade-in">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-400">Building the future with AI-powered tools.</p>
          </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.25s' }}>
            <h4 className="text-lg font-semibold mb-4">Leads</h4>
            <ul className="space-y-2">
              <li><Link to="/leads" className="text-gray-400 hover:text-white transition-colors duration-300">View Leads</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <p className="text-gray-400">© {new Date().getFullYear()} AIForge. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

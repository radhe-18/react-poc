...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section style={{ background: `linear-gradient(to br, ${theme.colors.bg}, ${theme.colors.text})` }} className="py-20">
        <div className="container mx-auto px-6 text-center animate-fade-in">
          <div className="max-w-4xl mx-auto">
            <h1 style={{ color: theme.colors.text }} className="text-5xl md:text-6xl font-bold mb-6 animate-slide-up">
              ...
              <span style={{ background: `linear-gradient(to r, ${theme.colors.accent}, ${theme.colors.text})` }} className="text-transparent bg-clip-text"> AIForge</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              >
                <span style={{ color: theme.colors.text }}>Get Started Free</span>
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg style={{ color: theme.colors.accent }} className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
